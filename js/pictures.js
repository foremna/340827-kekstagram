...
var getRandElement = function (tag) {
...
var openPhotoComments = openPhoto.querySelector('.comments-count'); // описание открытой фотографии
...
var openPhotoComments = openPhotoSocialComments.querySelector('.social__comment'); // комментарий
...
var createOpenPhoto = function () {
  ...
  openPhotoComments.textContent = picture[1].comments;
